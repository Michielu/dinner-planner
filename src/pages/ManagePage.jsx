  ...
  return (
    <div className="p-6 space-y-10 max-w-2xl mx-auto">
      ...
      <section>
        ...
        <p className="text-sm text-stone-grey mb-4">Items we want to make sure we have every week.</p>
      ...
      {/* Ingredients */}
      <section>
        <h2 className="font-display font-light text-2xl text-soil-shadow mb-1">Ingredients</h2>
        <p className="text-sm text-stone-grey mb-4">One-off or occasional items used in recipes and the grocery list.</p>
        ...
        <ul className="space-y-2">
          {filteredIngredients.map(ing => (
            <li key={ing.id} className="bg-willow-mist rounded-2xl px-5 py-3 shadow-card">
